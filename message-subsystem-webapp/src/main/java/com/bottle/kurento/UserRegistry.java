...
public class UserRegistry {
    ...
    public String getRandomName() {
        ...
        Object[] keys = usersByName.keySet().toArray();
        String randomName = keys[new Random().nextInt(keys.length)].toString();
        Random random = new Random();
        System.out.println("Random int:" + random.ints(0,usersByName.size()));
        return randomName;
    }
